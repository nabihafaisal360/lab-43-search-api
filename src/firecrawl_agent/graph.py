...
from firecrawl_agent.configuration import llm_with_tools
#from agent.tools import tools
from firecrawl_agent.tools import firecrawl_search
from firecrawl_agent.state import AgentState
...
# tool lookup
tools_by_name = {firecrawl_search.name: firecrawl_search}
